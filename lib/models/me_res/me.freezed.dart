...
class _$_Me implements _Me {
  ...
  @override
  String toString() {
    return 'Me(dateJoined: $dateJoined, email: $email, level: $level, ownerFk: $ownerFk, chainManagerFk: $chainManagerFk, managerFk: $managerFk, branchFk: $branchFk, tel: $tel, address: $address, facebook: $facebook, line: $line, ig: $ig, id: $id, verified: $verified, username: $username, firstName: $firstName, lastName: $lastName, exp: $exp, workingStatus: $workingStatus, profileImageUrl: $profileImageUrl)';
  }
...
abstract class _Me implements Me {
  factory _Me(
      ...
      final String? exp,
      final String? workingStatus,
      final String? profileImageUrl}) = _$_Me;
