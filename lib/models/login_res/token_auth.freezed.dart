...
/// @nodoc
class __$$_TokenAuthCopyWithImpl<$Res> extends _$TokenAuthCopyWithImpl<$Res>
    implements _$$_TokenAuthCopyWith<$Res> {
  __$$_TokenAuthCopyWithImpl(
      _$_TokenAuth _value, $Res Function(_$_TokenAuth) _then)
      : super(_value, (v) => _then(v as _$_TokenAuth));

  @override
  _$_TokenAuth get _value => super._value as _$_TokenAuth;
...
class _$_TokenAuth implements _TokenAuth {
  _$_TokenAuth(
      {this.success, this.errors, this.token, this.refreshToken, this.user});
  ...
  @override
  String toString() {
    return 'TokenAuth(success: $success, errors: $errors, token: $token, refreshToken: $refreshToken, user: $user)';
  }
